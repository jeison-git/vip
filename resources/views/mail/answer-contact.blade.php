                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                                <a href="https://meganegociosvip.com/" style="text-decoration:none;"><img
                                        src="{{ asset('img/logoLogin.png') }}" width="165" alt="Logo"
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                ...
                                <p style="margin-top:0;margin-bottom:12px;text-align:justify;">{!! $contact->answer->body !!}</p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td
                                ...
                                <p style="margin:0;font-size:14px;line-height:20px;"> Copyright &reg; 2021 Meganegocios
                                    Vip C.A. All
                                    rights reserved<br><a class="unsub" href="https://meganegociosvip.com/"
