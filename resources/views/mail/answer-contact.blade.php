        ...
        <td align="left"
            ...
            <div
                ...
                <p style="text-align: center; margin: 10px 0; margin-top: 10px; margin-bottom: 10px;">
                    <span style="font-size:15px;text-align:center;line-height:22px;color:#55575D;">
                        <br>
                        <br>
                    </span>
                </p>
        ...
        <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td
                            style="direction:ltr;font-size:0px;padding:0 0 0 0;padding-bottom:40px;padding-top:40px;text-align:center;">
        ...
        <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td
                            style="direction:ltr;font-size:0px;padding:0 0 0 0;padding-bottom:20px;padding-top:0px;text-align:center;">
                            <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]-->
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" vertical-align="top"
                                                style="font-size:0px;padding:0 0 0 0;padding-top:10px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                                                <div
                                                    style="font-family:Arial, sans-serif;font-size:13px;letter-spacing:normal;line-height:1;text-align:left;color:#000000;">
                                                    <h1 class="text-build-content"
                                                        style="text-align:center;; margin-top: 10px; margin-bottom: 10px; font-weight: normal;"
                                                        data-testid="fHVQ2RrDc_O"><span
                                                            style="color:#4BB9F1;font-size:26px;line-height:18px;"><b>Gracias
                                                                por comunicarte con nosotros</b></span></h1>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" vertical-align="top"
                                                style="font-size:0px;padding:0 0 0 0;padding-top:0px;padding-right:25px;padding-bottom:10px;padding-left:25px;word-break:break-word;">
                                                <div
                                                    style="font-family:Arial, sans-serif;font-size:13px;letter-spacing:normal;line-height:1;text-align:left;color:#000000;">
                                                    <p style="text-align: left; margin: 10px 0; margin-top: 10px;"><span
                                                            style="font-size:15px;text-align:left;line-height:22px;color:#55575D;">Estimado
                                                            {{ $contact->name }}.</span></p>
                                                    <p style="text-align: left; margin: 10px 0; margin-top: 10px;"><span
                                                            style="font-size:15px;text-align:left;line-height:22px;color:#55575D;">Nos
                                                            comentó que
                                                            {{ $contact->issue }}, dicho asunto es de muchísima
                                                            importancia para nosotros, esperamos que esta respuesta sea
                                                            de tu agrado.</span></p>
                                                    <p style="text-align: left; margin: 10px 0;"><span
                                                            style="font-size:15px;text-align:left;line-height:22px;color:#55575D;">{!! $contact->answer->body !!}</span>
                                                    </p>
                                                    <p style="text-align: left; margin: 10px 0; margin-bottom: 10px;">
                                                        <span
                                                            style="font-size:15px;text-align:left;line-height:22px;color:#55575D;">Con
                                                            mucho cariño el equipo de trabajo de Meganegocios Vip</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td
                                                                                ...
                                                                                <a href="https://www.facebook.com/Meganegocios-Vip-ca-1004343212943696/"
                                            ...
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span
                                                            style="font-size:15px;text-align:center;line-height:22px;color:#55575D;">This
                                                            e-mail has been sent to {{ $contact->email }}, <a
                                                                href="[[UNSUB_LINK_EN]]"
                                                                style="color:inherit;text-decoration:none;"
                                                                target="_blank">click here to unsubscribe</a>.</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="text-align: center; margin: 10px 0; margin-top: 10px; margin-bottom: 10px;">
                                                        <span
                                                            style="font-size:15px;text-align:center;line-height:22px;color:#55575D;">
                                                            VE</span>
                                                    </p>
                                                </div>
                                            </td>
