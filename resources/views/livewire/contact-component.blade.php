<div >
    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="description">
            ...
            <div class="">
            <p class="text-sm text-justify text-gray-700 "> Si tienes alguna duda o pregunta, estamos aquí para ayudarte en todo lo que necesites saber acerca de
                Meganegocios Vip
                y tu Mega Tienda virtual Vip. Sin importar el día:
                <br>
                Queremos asesorarte en tu compra o ayudarte con tu orden.
                Escoge uno de los siguientes medios para comunicarte con nosotros.
                <br>
                Si estás dentro del horario, te recomendamos chatear con nosotros,
            ...
            <div class="flex items-center mb-2 text-sm text-gray-600"><img class="mr-2"
                    src="https://img.icons8.com/dusk/20/000000/like-message.png" /> Email: contacts@meganegociosvip.com
            </div>

            <div class="flex items-center mb-2 text-sm text-gray-600"><img class="mr-2"
                    src="https://img.icons8.com/dusk/20/000000/address.png" /> Dirección física: Meganegocios Vip | Edf:
