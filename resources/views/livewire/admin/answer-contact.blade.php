<div >
        ...
        <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <h1 class="flex items-center font-semibold leading-tight text-gray-800 md:text-2xl">
                    <a href="{{ URL::previous() }}" class="mr-2"><img src="https://img.icons8.com/dusk/25/000000/circled-left-2.png"/></a>Mensaje
                </h1>
    ...
    <div class="max-w-4xl px-4 py-12 mx-auto text-gray-700 sm:px-6 lg:px-8">
        ...
        <h1 class="mb-8 font-semibold text-center md:text-2xl">Por favor lea detenidamente esta información, para  que luego responda adecuadamente los requerimientos del usuario</h1>
