    ...
    <section class="py-16">
        ...
        <div class="bg-white rounded-lg shadow-lg">
            ...
            <div class="flex items-center justify-between px-6 py-2">
                ...
                <div class="container topbar-menu-area">
                    <div class="items-center topbar-menu">
                        <ul>
                            ...
                            <li class="text-sm cursor-pointer menu-item menu-item-has-children parent">{{-- filtros por  categorias --}}
                            ...
                            <li class="ml-6 text-sm cursor-pointer menu-item menu-item-has-children parent">{{-- filtros por subcategorias --}}
                            ...
                            <li class="ml-6 text-sm cursor-pointer menu-item menu-item-has-children parent">{{-- filtros por marcar --}}
                            ...
                            <li class="ml-6 text-sm cursor-pointer menu-item menu-item-has-children parent">{{-- limpiar filtros --}}
                ...
                <div class="grid grid-cols-1 text-gray-500 border border-gray-200 divide-gray-200 md:grid-cols-2">{{-- opciones para visualizar  card de productos: listas o columnas --}}
            ...
            <div class="flex items-center justify-between block">
                @auth
                    <span class="flex text-xs text-center text-gray-700 uppercase md:text-2xl ">
                        {{ Auth::user()->name }} bienvenido a tu espacio personalizado Vip
                    </span>                    
                @endauth                
                ...
                @if ($view == 'grid')
                    <ul class="grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
                        ...
                        <div class="flex flex-col items-center justify-center h-full bg-gray-100">{{-- tarjeta que muestra informacion del producto --}}
                            ...
                            <img class="object-contain w-64 h-64 rounded-t-md" src="{{ Storage::url($product->images->first()->url) }}"
                            ...
                            <div class="mt-4">{{-- detalles del producto, nombre, etc --}}
                                ...
                                <a href="{{ route('vip-client') }}"
                                    class="flex items-center mt-2 text-xs font-semibold text-gray-700 "> Mega Oferta Clientes <svg class="ml-2 " xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30"
                                ...
                                <div class="flex justify-between pl-4 pr-2 mt-4 mb-2">{{-- precio real del producto y boton que redirecciona a la vista del producto --}}
                                    ...
                                    <button class="block text-xl font-semibold text-gray-700 cursor-auto">
                                        ${{ $product->price }}{{-- cambiar variable por $price --}}
                                    </button>
