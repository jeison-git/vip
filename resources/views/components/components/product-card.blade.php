    ...
    <div
        ...
        <div class="mt-4">{{-- detalles del producto, nombre, etc --}}
            ...
            <a href="{{ route('vip-client') }}"
                class="flex items-center mt-2 text-xs font-semibold text-gray-700 uppercase "> ${{ $product->price }}
                solo Clientes <svg class="ml-2 " xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30"
